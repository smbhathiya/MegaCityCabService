...
<head>
    ...
    <title>Admin Help - Mega City Cabs</title>
            ...
            <div class="flex items-center gap-4">
                <a href="../index.jsp" class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-light/70">Admin Help</p>
                    </div>
                </a>
            </div>
...
<main class="pt-28 pb-12 px-6">
    <div class="container mx-auto">
        <h1 class="text-4xl font-bold text-white mb-8 text-center">Admin Help Center</h1>

        <div class="card mb-6">
            <h2 class="text-2xl font-bold text-white mb-4">Managing the Dashboard</h2>
            <p class="text-light/80">As an admin, you can oversee the entire system:</p>
            <ul class="list-disc list-inside text-light/80">
                <li><strong>Dashboard Overview</strong>: View total cars, drivers, active bookings, and revenue.</li>
                <li><strong>Manage Cars</strong>: Add, edit, or remove vehicles from the fleet.</li>
                <li><strong>Manage Drivers</strong>: Approve drivers, assign cars, and monitor performance.</li>
                <li><strong>Reports</strong>: Generate reports on revenue, bookings, and utilization.</li>
            </ul>
        </div>

        <div class="card mb-6">
            <h2 class="text-2xl font-bold text-white mb-4">How to Add a Car</h2>
            <p class="text-light/80">Go to "Manage Cars" in the dashboard:</p>
            <ul class="list-disc list-inside text-light/80">
                <li>Click "Add Car".</li>
                <li>Enter details like plate number, model, brand, year, and capacity.</li>
                <li>Save to update the fleet.</li>
            </ul>
        </div>

        <div class="card mb-6">
            <h2 class="text-2xl font-bold text-white mb-4">Generating Reports</h2>
            <p class="text-light/80">Use the "Reports" section to analyze system performance:</p>
            <ul class="list-disc list-inside text-light/80">
                <li>Select a date range and click "Generate".</li>
                <li>View revenue, booking summaries, driver performance, and vehicle utilization.</li>
                <li>Use "Print" or "Download PDF" to export the data.</li>
            </ul>
        </div>

        ...
        <div class="container mx-auto px-4 relative z-10 flex ">
            <div class="max-w-2xl space-y-6">
                ...
                <div class="flex gap-4">
                    <a href="/bookings/new"
                       class="px-6 py-3 bg-primary text-black rounded-md hover:bg-primary-700 transition flex gap-2">
                        <i data-lucide="calendar-check" class="w-5 h-5"></i>
                        Book Now
                    </a>
                    <a href="/vehicles"
                       class="px-6 py-3 border border-gray-700 text-white rounded-md hover:bg-white/10 transition flex items-center gap-2">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center ">
            <div>
                <img src="${pageContext.request.contextPath}/views/assests/cab1.webp" alt="Luxury Car Interior"
                     class="w-3/4 rounded-lg shadow-xl p-5 items-center">
            </div>
            <div>
                ...
                <a href="${pageContext.request.contextPath}/views/customer/customerRegister.jsp"
                   class="mt-8 inline-block px-6 py-3 bg-primary text-black rounded-md hover:bg-primary-700 transition">
                    Join Now
                </a>
            </div>
        </div>
    ...
    <section class="container mx-auto px-4 py-16 section-bg">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-dark/50 p-6 rounded-lg border border-white/10">
                ...
                <div class="flex items-center gap-3">
                    <div>
                        <p class="font-semibold text-white"><%= review[0] %>
                        </p>
                        <p class="text-sm text-gray-400"><%= review[1] %>
                        </p>
                    </div>
                </div>
            </div>

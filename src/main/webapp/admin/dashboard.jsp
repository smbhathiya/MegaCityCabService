    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-dark/50 border border-white/10 rounded-lg">
            ...
            <tr class="border-b border-white/10">
                ...
                <td class="px-4 sm:px-6 py-4">Manager</td>
                <td class="px-4 sm:px-6 py-4">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" checked class="sr-only peer" onchange="toggleUserStatus(this)">
                ...
                <td class="px-4 sm:px-6 py-4 flex gap-2">
                    <button onclick="openEditUserModal('John Doe', 'john.doe@example.com', 'Manager')" class="bg-blue-500 px-4 py-2 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Edit</button>
                </td>
            </tr>
            </tbody>
        </table>
...
<script>
    ...
    function toggleUserStatus(checkbox) {
        ...
        if (checkbox.checked) {
            ...
            // Perform enable action (e.g., API call)
        } else {
            statusText.textContent = 'Disabled';
            // Perform disable action (e.g., API call)
        }
    }
</script>
</body>

...
public class CarDAO {
    ...
    // Change Car Status (Available/Unavailable)
    public boolean changeCarStatus(UUID id, String status) {
        String sql = "UPDATE cars SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?";

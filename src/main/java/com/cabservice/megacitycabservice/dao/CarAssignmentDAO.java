...
//    // Assign a car to a driver
//    public boolean assignCarToDriver(UUID driverId, UUID carId) throws SQLException {
//        String checkQuery = "SELECT car_id FROM drivers WHERE id = ?";
//        String updateQuery = "UPDATE drivers SET car_id = ?, updated_at = NOW() WHERE id = ? AND car_id IS NULL";
//
//        Connection conn = null;
...
//            checkStmt.setObject(1, driverId.toString());
//            rs = checkStmt.executeQuery();
//
//            if (rs.next() && rs.getObject("car_id") != null) {
//                conn.rollback();
//                return false; // Driver already has a car
//            }
//
//            // Assign car
//            updateStmt = conn.prepareStatement(updateQuery);
...
//            if (rowsAffected == 0) {
//                conn.rollback();
//                return false; // Driver not found or already assigned
//            }
//
//            conn.commit();
//            return true;
